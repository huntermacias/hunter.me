...
export const travelImages = [
  ...
  { img: image4, title: 'Finally an executive adult!', alt: 'Picture taken in Las Vegas, USA' },
  ...
  { img: image6, title: 'Stranger Things Exhibit - Las Vegas, USA', alt: 'Picture taken in Las Vegas, USA' },
  {
    ...
    alt: 'Picture taken at Vodoo Donuts in Portland Oregon',
  },
  { img: image8, title: 'Washington State Fair', alt: 'Washington State Fair' },
  { img: image9, title: 'Why so much milk?', alt: 'Picture taken in Seattle, WA' },
  { img: image10, title: 'First Rainy bike ride', alt: 'Picture taken in Seattle, WA' },
  {
    img: image11,
    title: "lucholibre Championship",
    alt: "Seattle Washington",
  },
  { img: image12, title: 'The Gorge Amphitheater', alt: 'The Gorge Amphitheater' },
  {
    img: image13,
    title: 'The Gorge',
    alt: 'Music Festival',
  ...
  { img: image15, title: 'Lone Mountain, USF', alt: 'Picture taken at Lone Mountain Hilltop' },
  {
    img: image16,
    title: 'Los Angeles, California',
    alt: 'Picture taken in Los Angeles, California',
  },
  { img: image17, title: 'San Francisco, CA', alt: 'Picture taken in San Francisco, CA' },
  {
    img: image18,
    title: 'Downtown San Francisco', alt: 'Picture taken in San Francisco, CA' ,
  },
  {
    img: image19,
    title: 'White Water Rafting',
    alt: 'Picture taken in Oregon, USA',
  },
  { img: image20, title: 'My first time in snow', alt: 'Picture taken in St. Louis, Missouri' },
  { img: image21, title: 'Family', alt: 'Picture taken in Santa Rosa, CA' },
  {
    img: image22,
