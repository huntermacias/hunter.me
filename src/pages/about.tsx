        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          <div className="lg:pl-20">
            <div className="max-w-xs px-2.5 lg:max-w-none ">
              <Image
                src={AvatarImage}
                alt=""
                sizes="(min-width: 25px) 8rem, 5rem"
                className="rounded-2xl bg-zinc-100  dark:bg-zinc-800 border-2 border-red-700"
              />
            </div>
          </div>
          <div className="lg:order-first lg:row-span-2">
            ...
            <Section>
              ...
              <Section.Content>
                Hey there! I&apos;m Hunter Macias Rocha, a software developer based in San
                Francisco, weaving magic in tech with my fingertips. I might be a recent CS grad,
                but don&apos;t let that fool you – I&apos;ve got a rich tapestry of experiences
                under my belt. I&apos;m currently shaping young minds as a Coding Coach at The Coder
